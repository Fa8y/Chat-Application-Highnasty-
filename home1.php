    ...
    <div class="sidebar">
      ...
      <div class="sidebar__profile">
        <div>
          ...
          <img src="<?php echo $_SESSION['picture'] ?>" alt="avatar" />
       
         
        </div>
        <div class="sidebar__profileInfo">
            
          <h3><?php echo $_SESSION['givenName'] ?>&nbsp;<?php echo $_SESSION['familyName'] ?></h3>
...
function sendMessage(e) {
    ...
    if(input.value !== "") {
        ...
        avatar.src = "<?php echo $fetch['picture']; ?>";

        var messageInfo = document.createElement("div")
        messageInfo.className = "message__info"

        var userInfo = document.createElement("h4")
        userInfo.innerHTML = "<?php echo $_SESSION['givenName'] ?><?php echo $_SESSION['familyName'] ?>";
