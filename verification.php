                    ...
                    <div class="card-body">
                        <form action="#" method="POST">
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="text" id="otp" class="form-control" name="otp_code"  maxlength="6" onkeyup="numberonly(this)" required autofocus style="width:136px">
                                </div>
                            </div>
    ...
    if(isset($_POST["verify"])){
        ...
        if($otp != $otp_code){
           ...
           <?php
            ...
            mysqli_query($conn, "UPDATE tbl_user SET status = 1 WHERE email = '$email'");
            ?>
             <script>
